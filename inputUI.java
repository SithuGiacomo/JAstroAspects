    ...
    public inputUI() {
        ...
        buttonInput.addActionListener(ae -> {
            if (ae.getSource() == buttonInput) {
                ...
                pnhData meObj = new pnhData("Mercury",me,chkMe.isSelected());
                pnhData juObj = new pnhData("Jupiter",ju,chkJu.isSelected());
                pnhData veObj = new pnhData("Venus",ve,chkVe.isSelected());
                pnhData saObj = new pnhData("Saturn",sa,chkSa.isSelected());
                pnhData raObj = new pnhData("Rahu",ra,chkRa);
                pnhData keObj = new pnhData("Ketu",ke,chkKe);
                pnhData foObj = new pnhData("For",fo,chkFo);
                pnhData IObj = new pnhData("I",I,chkI);
                pnhData IIObj = new pnhData("II",II,chkII);
                pnhData IIIObj = new pnhData("III",III,chkIII);
                pnhData IVObj = new pnhData("IV",IV,chkIV);
                pnhData VObj = new pnhData("V",V,chkV);
                pnhData VIObj = new pnhData("VI",VI,chkVI);
                pnhData VIIObj = new pnhData("VII",VII,chkVII);
                pnhData VIIIObj = new pnhData("VIII",VIII,chkVIII);
                pnhData IXObj = new pnhData("IX",IX,chkIX);
                pnhData XObj = new pnhData("X",X,chkX);
                pnhData XIObj = new pnhData("XI",XI,chkXI);
                pnhData XIIObj = new pnhData("XII",XII,chkXII);
